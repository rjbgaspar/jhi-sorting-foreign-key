...
import com.jhipster.demo.bootifulmusic.BootifulmusicApp;
import com.jhipster.demo.bootifulmusic.config.AsyncSyncConfiguration;
import com.jhipster.demo.bootifulmusic.config.EmbeddedSQL;
...
@SpringBootTest(classes = { BootifulmusicApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
