...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jhipster.demo.bootifulmusic.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.jhipster.demo.bootifulmusic.security.DomainUserDetailsService", "createSpringSecurityUser");
